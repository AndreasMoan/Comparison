...
public class FitnessEvaluation implements FitnessEvaluationProtocol {
    ...
    @Override //The normalized Hamming distance counts the number of orders that are delivered with a different PSVs, and the number of orders that are placed on different places in the chromosome
